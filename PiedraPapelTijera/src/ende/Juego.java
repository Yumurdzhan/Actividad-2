...
public class Juego
{
	public static void main(String args[])
	{
		...
		Integer EmPaTeS = 0; // nombres de variables utilizando lowerCamelCase
...
class Jugador
{
	 ...
	 */
	public String opcion_al_azar() // nombres de metodos sin barras bajas
	{
		String opcion = "";
	...
	public void setÉxitos() // nombres de métodos sin tildes
	{
		éxitos++;
	}
